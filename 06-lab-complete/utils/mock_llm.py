"""
Mock LLM — shared across all examples.
No real API key needed. Returns canned responses so the lab can focus on
deployment concepts rather than LLM integration.
"""
import time
import random
