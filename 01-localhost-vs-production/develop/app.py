...
# ❌ Vấn đề 6: Không có error handling
# Nếu ask() throw exception, server sẽ crash luôn

# ❌ Vấn đề 7: Không có tests, không có CI/CD
# Nếu có bug, sẽ không biết ngay mà phải deploy mới biết

# ❌ Vấn đề 8: Không có documentation, không có API schema
# Nếu người khác muốn dùng API này, sẽ rất khó khăn để hiểu cách gọi
